...
(function () {
  ...
  function initChat() {
    ...
    function open() { panel.hidden = false; toggleBtn.setAttribute('aria-expanded', 'true'); input?.focus(); }
    function close() { panel.hidden = true; toggleBtn.setAttribute('aria-expanded', 'false'); }

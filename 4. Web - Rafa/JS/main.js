...
(function () {
  ...
  function openCart() {
    ...
    document.getElementById('floating-actions')?.classList.add('shift-left');
    document.body.style.overflow = 'hidden';
  }
  function closeCart() {
    document.getElementById('cart-drawer')?.classList.remove('open');
    document.getElementById('cart-overlay')?.classList.remove('open');
    document.getElementById('floating-actions')?.classList.remove('shift-left');
  ...
  function initMobile() {
    ...
    function open() {
      ...
      document.getElementById('floating-actions')?.classList.add('shift-right');
      document.body.style.overflow = 'hidden';
    }
    function shut() {
      ...
      document.getElementById('floating-actions')?.classList.remove('shift-right');
      document.body.style.overflow = '';
    }
